...
import { z } from 'zod';
import { TiktokCTAAdSchema } from './schema';
import { ArtifactMedia } from '../../components/ArtifactMedia';
import { TiktokAdFooterCTA } from './components/TiktokAdFooterCTA';

export const TiktokAdCTAToolSchema = {
  description: 'Generate a Tiktok Ad CTA',
  inputSchema: z.object({
    name: z.string().describe('Name of the Tiktok Ad CTA'),
    type: z.enum(['ad-template:tiktok-cta']).describe('Type identifier for this ad format'),
    content: TiktokCTAAdSchema,
  }),
};
